...
```{r}
scaled.pca.T <- prcomp(transMetabData[c(6:691)], scale = TRUE, center = TRUE) #Use prcomp to perform a centered and scaled PCA calculation
...
```{r}
scaled.pca.T.id <- prcomp(transMetabData[c(6:190)], scale = TRUE, center = TRUE) #Use prcomp to perform a centered and scaled PCA calculation
