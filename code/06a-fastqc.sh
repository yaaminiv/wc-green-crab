...
#SBATCH --chdir=/vortexfs1/scratch/yaamini.venkataraman/wc-green-crab/output/06a-fastqc/	# Working directory for this script
...
output_dir=/vortexfs1/scratch/yaamini.venkataraman/wc-green-crab/output/06a-fastqc/
...
raw_reads_dir=/vortexfs1/omics/tepolt/raw_reads/C_maenas/Cm_yrv_2023/
