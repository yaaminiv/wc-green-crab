...
ggsave("../../output/02-demographic-data/figures/stacked-graph-integument-color.pdf",
         height = 8.5,
       width = 11)
```
...
merged_data %>%
  ...
  scale_fill_manual(name = "sex",
                    values = c("F" = "darkturquoise",
                               "M" = "#D53E4F"
                               )) +
  scale_y_continuous(labels = scales::percent) +
  theme_classic() +
  theme(legend.position = "bottom")
ggsave("../../output/02-demographic-data/figures/stacked-graph-sex-treatment.pdf",
         height = 8.5,
       width = 11)
```
