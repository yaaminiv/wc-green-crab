# PID of current job: 2070228
mSet<-InitDataObjects("conc", "pathora", FALSE, 150)
cmpd.vec<-c("pyrophosphate","adenine","glucose-1-phosphate","UDP-N-acetylglucosamine","cytidine-5-monophosphate","fructose-6-phosphate","glucose-6-phosphate","2,5-dihydroxypyrazine","adenosine","glycerol","cytosine","levoglucosan","fructose","alpha-ketoglutarate","2-hydroxyglutaric acid","fructose-1-phosphate","saccharic acid","citric acid","galactose-6-phosphate","ethanolamine","phenylalanine","2,4-diaminobutyric acid","isomaltose","glutathione","nicotinamide","maleimide")
...
mSet<-RerenderMetPAGraph(mSet, "zoom1765304285235.png",576.0, 480.0, 100.0)
