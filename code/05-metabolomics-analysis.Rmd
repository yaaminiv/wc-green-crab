...
```{r}
dissim.T <- vegdist(scale(transMetabData[c(6:691)]), "euclidean") #Create euclidean dissimilarity matrix to use for perMANOVA and PERMDISP
```
...
```{r}
dissim.T.id <- vegdist(scale(transMetabData[c(6:190)]), "euclidean") #Create euclidean dissimilarity matrix to use for perMANOVA and PERMDISP
```
