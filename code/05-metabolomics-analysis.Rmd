...
```{r}
final.splsda.tempGen.known <- splsda(X_tempGen, Y_tempGen, ncomp = 2, keepX = select.keepX) #Use the number of components and metabolites to keep based on optimization from above
