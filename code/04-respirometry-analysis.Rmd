...
```{r}
write.csv(dat20230705_MO2_all_slope_results, "20220708-MO2-slope-results.csv", quote = FALSE, row.names = FALSE) #Save results with uncorrected, blank, and corrected slopes
```
...
```{r}
hist(-(dat20230705_MO2_slope_results$slope_nmol_hr_corrected)) #Check distribution
hist(log(-(dat20230705_MO2_slope_results$slope_nmol_hr_corrected))) #Check log transformation
hist(sqrt(-(dat20230705_MO2_slope_results$slope_nmol_hr_corrected))) #Check sqrt transformation
```

```{r}
lm20220708 <- lm(log(-slope_nmol_hr_corrected) ~ treatment, data = dat20230705_MO2_slope_results)
summary(lm20220708)
```
...
```{r}
all_MO2_slope_results <- bind_rows("04" = dat20230705_MO2_all_slope_results,
