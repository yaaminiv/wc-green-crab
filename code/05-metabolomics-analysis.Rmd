...
```{r}
treatmentDay.known.plsda.tuned <- plsda(X_tempTime, Y_tempTime, ncomp = 3) #Initially set a higher number for the number of components since we will be testing this
plotIndiv(treatmentDay.known.plsda.tuned) #Preliminary PLS-DA
```
