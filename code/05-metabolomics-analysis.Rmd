...
To answer questions 1 and 2, I can follow a protocol [similar to one I've used previously](https://github.com/yaaminiv/green-crab-metabolomics/blob/main/code/05-metabolomics-analysis.Rmd) to examine the impact of temperature, time, and their interaction on the metabolome. To answer question 3, I will need to subset data to the beginning and end of the experiment, then examine the impact of temperature, genotype, and their interaction on the metabolome.

# Impact of temperature, time, and their interaction on the metabolome
