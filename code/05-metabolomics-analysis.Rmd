...
- match shapes and color to PCA figures
...
plotIndiv(treatmentDay.known.plsda.tuned, comp = c(1,3), ind.names = FALSE,
          ...
          ellipse = TRUE, star = TRUE, centroid = FALSE, 
          legend = FALSE,
          title = "PLS-DA by Temperature and Day", X.label = "Component 1: 19% Explained Variance", size.xlabel = 15, Y.label = "Component 3: 3.9% Explained Variance", size.ylabel = 15, size.axis = 13,
...
ncomp #5 components! That's in-line with the perf analysis above for centroids distance
...
sum(select.keepX[1:3]) #PLS-DA can be run with 235 features total for 3 components, which is less than the total number of variables I'm testing here.
```
